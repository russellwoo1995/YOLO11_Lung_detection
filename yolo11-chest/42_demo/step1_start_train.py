...
results = model.train(data=r'C:\Users\Scm97\Desktop\bilibili\eng\yolo11-chest\ultralytics\cfg\datasets\A_my_data.yaml', project="./runs", epochs=200, imgsz=640, device=[], workers=0, batch=16, cache=True, resume=True, amp=False)  # CPU 开始训练
